...
<head>
    ...
    <title>Inserted Foods Inventory</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'foods.php' ? 'active' : ''; ?>"
                            href="foods.php">Manage Food List</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'beverages.php' ? 'active' : ''; ?>"
                            href="beverages.php">Manage Beverage List</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container my-4">
        <div id="searchByDate" class="mb-4">
            ...
            <button class="btn btn-secondary" onclick="listAllRecords()"><i class="bi bi-list"></i> List all</button>
        </div>

        <h2 class="text-center">Inserted Foods Inventory</h2>
    ...
    <script>
        // Function to fetch and display today's report by default
        window.onload = function () {
            var today = new Date().toISOString().split('T')[0]; // Get today's date in YYYY-MM-DD format
            document.getElementById('searchDate').value = today; // Set the date input to today's date
            searchByDate(today); // Automatically search for today's date
        };
        ...
        function searchByDate(searchDate = null) {
            ...
            xhr.open('GET', 'searchInsertedInventory.php?searchDate=' + searchDate, true);
        ...
        function listAllRecords() {
            // Create a new XMLHttpRequest object
            var xhr = new XMLHttpRequest();
            xhr.open('GET', 'searchInsertedInventory.php?listAll=true', true);
